...
/*
	...
	function DSObjectCollection(){
		...
		var setCache = function(){
			...
			if( fs.existsSync( corrent.downloadPath ) ){
				corrent.cache = corrent.downloadPath;
			}
			else{
				corrent.cache = undefined;
			}

		};

		var setDownloadPath = function(){
			corrent.downloadPath = "./cache/" + corrent.fileName;
		};

		var setFileName = function(){
			corrent.fileName = getFileName(corrent.link);
		};

		

		var setUnzipPath = function(){
			corrent.unzipPath = "./downloads/" + corrent.tableName + "/";
		};
