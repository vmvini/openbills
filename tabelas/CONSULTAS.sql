...
;select distinct b.ANO_ELEICAO,  sum (b.VALOR_BEM) from BEM_CANDIDATO b, CONSULTA_CAND c WHERE c.CPF_CANDIDATO = '23336951291' AND c.SEQUENCIAL_CANDIDATO = b.SQ_CANDIDATO group by b.ANO_ELEICAO order by b.ANO_ELEICAO asc ;
...
;select c.ANO_ELEICAO, c.NOME_CANDIDATO, c.CPF_CANDIDATO from CONSULTA_CAND c where c.DESC_SIT_TOT_TURNO = 'ELEITO'  and c.CPF_CANDIDATO = '37282271291';
